...
public class Ch15_nonPBRShooting : SoliderShooting
{
    protected override void SpawnMuzzle(AttackPoint firePoint)
    {
        EffectCtrl projectilePrefabs = EffectSpawnerCtrl.Instance.Prefabs.GetByName(EffectCode.Muzzle_ElectricBall01_Yellow.ToString());
    ...
    {
        EffectCtrl MuzzlePrefabs = EffectSpawnerCtrl.Instance.Prefabs.GetByName(EffectCode.Projectile_ElectricBall01_Yellow.ToString());
